...
public class Lambda_01_Test {
    ...
    public void test_filter_by_firstname() throws Exception {
        ...
        List<Person> result = filter(personList, p -> StringUtils.equals(p.getFirstname(),"first_10"));
    ...
    public void test_filter_by_password() throws Exception {
        ...
        List<Person> result = filter(personList, p -> p.getAge() > 49 && StringUtils.equals(DigestUtils.sha512Hex(p.getPassword()), passwordSha512Hex));
